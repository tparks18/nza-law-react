              ...
              <div class="grid-container">
                <div class="left-sidebar">
                  <div class="left-sidebar-content">
                    ...
                    <div class="left-sidebar-img-container">
                      <img
                        class="stacked-newspapers"
                        src={stackedNewspapers}
                        width="238"
                        height="143"
                ...
                <div class="telephone-pic">
                  <img
                    class="telephone"
                    src={telephoneBanner}
                    alt="telephone contact"
                  />
                </div>

                <div class="contact-text">
                  <p>
                    The office hours are 8am - 5pm Monday through Friday
                    <br />
                    <br />
                    ...
                    <br /> FAX: 555.555.5555
                    <br />
                    <br /> Contact Rosemary Sage at{" "}
                    <a href="index.html">rosemary@lawfirm.com</a>
                    <br />
                    <br />
                  </p>
                </div>
                    ...
                    <div class="map-pic">
                      ...
                      <div class="group-pic">
                        <img
                          ...
                          width="238"
                          height="112"
                          alt="diverse group of lawyers"
                        />
                      </div>
                      <strong>News &#38; Events</strong>
                      <p>
                        {" "}
                        Join our magnificant firm and do more stuff with us.
                      </p>
                    </div>
                  </div>
                </div>
