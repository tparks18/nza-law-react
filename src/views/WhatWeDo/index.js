      ...
      <div className="row">
        <div className="col-3 gradient-style white-background">
          <h6 className="white-underline">WHAT WE DO</h6>
            ...
            <img class="img-fluid leather-chair-border" src={leatherChairs} alt="Leather Chairs" /> 
        ...
        <div className="col-9">
          ...
          <div className="row">
            <div className="col-6">
                <img class="large-pic-border" src={subrogation} alt="Subrogation" width="400" height="250" /> 
            ...
            <div className="col-6">
              <img class="large-pic-border" src={litigation} alt="Litigation" width="400" height="250" /> 
              <div className="text-in-image">
                <h3>LITIGATION</h3>
              </div>
            </div>
          ...
          <div className="row">
            <div className="col-6">
                <img class="large-pic-border" src={business} alt="Business" width="400" height="250" /> 
                <div className="text-in-image">
                  <h3>BUSINESS</h3>
                </div>
            </div>
            ...
            <div className="col-6">
              <img class="large-pic-border" src={transportation} alt="Transportation" width="400" height="250" /> 
              <div className="text-in-image">
